...
some information on the date, in this case the string "Hello".

To display the events in the fancy org-mode agenda along with holidays, I added
the following to my configuration:
